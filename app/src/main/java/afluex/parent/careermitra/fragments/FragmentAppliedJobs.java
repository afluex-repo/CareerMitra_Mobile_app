...
import afluex.parent.careermitra.adapter.AdapterAppliedJobs;
...
import afluex.parent.careermitra.model.response.ResponseAppliedJob.ResponseAppliedJob;
...
public class FragmentAppliedJobs extends BaseFragment implements JobDetailsListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       binding=FragmentJoblistBinding.inflate(inflater,container,false);
        ...
        binding.tvDept.setVisibility(View.GONE);
        binding.tvQualifi.setVisibility(View.GONE);
        binding.tvSkill.setVisibility(View.GONE);
    ...
    public void GetAppliedJobDetails() {
        showLoading();
        ...
        Call<ResponseCommon> call = apiServices.GetAppliedJobs(bodyParam(object));
        call.enqueue(new Callback<ResponseCommon>() {
            @Override
            public void onResponse(Call<ResponseCommon> call, Response<ResponseCommon> response) {
                hideLoading();

                ResponseAppliedJob responseAppliedJob;
                try {
                    if (response.body().getStatusCode().equals(200)) {
                        ...
                        responseAppliedJob = gson.fromJson(paramResponse, ResponseAppliedJob.class);
                        AdapterAppliedJobs adapter = new AdapterAppliedJobs(responseAppliedJob.getAppliedJobList(), context);
