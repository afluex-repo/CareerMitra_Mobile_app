...
import afluex.parent.careermitra.common.MethodUtil;
...
//                .show();
    ...
    public void requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(context, Manifest.permission.READ_EXTERNAL_STORAGE)
            ...
            MethodUtil.createSimpleDialog1(context, getString(R.string.alert_text), getString(R.string.permission_camera_rationale11), getString(R.string.reqst_permission), new MethodUtil.Method() {
                @Override
                public void execute() {
