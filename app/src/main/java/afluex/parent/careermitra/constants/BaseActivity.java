...
import afluex.parent.careermitra.activity.Login;
import afluex.parent.careermitra.app.PreferencesManager;
import afluex.parent.careermitra.common.DialogUtil;
import afluex.parent.careermitra.common.LoggerUtil;
import afluex.parent.careermitra.common.NetworkConnectionChecker;
...
import afluex.parent.careermitra.retrofit.ApiServices;
import afluex.parent.careermitra.retrofit.MvpView;
import afluex.parent.careermitra.retrofit.ServiceGenerator;
...
public class BaseActivity extends AppCompatActivity implements
    ...
    String keys1 = afluex.parent.careermitra.BuildConfig.ANDROID_ICON;
    String keys2 = "";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            keys2 = Cons.decryptMsg(afluex.parent.careermitra.BuildConfig.DWPAY_COMPARED, temp_compared);
...
//        easypay_key = new SecretKeySpec(Cons.decryptMsg(BuildConfig.EASYPAY_KEY, cross_intent).getBytes(), "AES");
    ...
    private void Logout(Class<?> activity) {
        showLoading();
        ...
        Call<ResponseCommon> call = apiServices.Logout(bodyParam(object));
    ...
    public void createInfoDialog(Context context, String title,
        ...
        builder1.setPositiveButton("OK", (dialog, which) -> {
            if (isBack)
                goToActivityWithFinish(BaseActivity.this, Login.class, null);
            dialog.cancel();
        });
...
//                (dialog, id) -> dialog.cancel());
    ...
    public void createLoginDialog(Context context, String title,
                                  String msg) {
        androidx.appcompat.app.AlertDialog.Builder builder1 = new androidx.appcompat.app.AlertDialog.Builder(context);
        builder1.setTitle(title);
        builder1.setMessage(msg);
    ...
    public void logoutDialog(Activity context, Class<?> activity) {
        ...
        builder1.setMessage(R.string.do_logout);
        builder1.setCancelable(true);
