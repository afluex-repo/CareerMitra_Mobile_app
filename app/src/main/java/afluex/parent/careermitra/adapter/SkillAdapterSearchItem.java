...
import afluex.parent.careermitra.model.response.responseFilters.SkillsItem;
...
public class SkillAdapterSearchItem extends RecyclerView.Adapter<SkillAdapterSearchItem.ViewHolder> {

    private List<SkillsItem> models;
    private Context context;

    public SkillAdapterSearchItem(List<SkillsItem> models, Context context) {
        this.models = models;
