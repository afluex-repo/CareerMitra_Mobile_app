...
public class PreferencesManager {
    ...
    //app login variables
    private static final String PREF_NAME = "afluex.parent.careermitra.PREF";
    ...
    //firstTime
    public void setIS_Language_selected(Boolean value) {
        mPref.edit().putBoolean(IS_Language_selected, value).apply();
    }

    public boolean getIslanguageSeleced() {
        return mPref.getBoolean(IS_Language_selected, true);
    }
    ...
    public void setLongitude(String value) {
        mPref.edit().putString(longitude, value).apply();
    }
    ...
    public void setLatitude(String value) {
        mPref.edit().putString(latitude, value).apply();
    }
    ...
    public String getLanguage() {
        return mPref.getString(language, "hi");
    }
}